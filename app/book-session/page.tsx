...
const BookSessionPage = () => {
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<section className="py-16 bg-white">
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-12">
						<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Our Service</h2>
						<p className="text-gray-600 max-w-2xl mx-auto">
						Professional beauty treatments and training programs designed to enhance your natural beauty
						</p>
					</div>
			...
			{/* About Lulu's Beauty Studio Section */}
			<section className="py-16 bg-white">
				<div className="max-w-7xl mx-auto px-6">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div>
							<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
								About Lulu's Beauty Studio
							</h2>
							<p className="text-gray-600 leading-relaxed mb-4">
								At Lulu's Beauty Studio, we are dedicated to providing exceptional beauty services and professional training. With years of experience in the industry, our expert team ensures that every client receives personalized care and attention to detail.
							</p>
							<p className="text-gray-600 leading-relaxed mb-6">
								We offer comprehensive training programs for aspiring beauty professionals, covering everything from classic techniques to advanced applications. Our commitment to quality and excellence sets us apart in the beauty industry.
							</p>
							<div className="grid grid-cols-3 gap-4">
								<div className="text-center p-4 bg-gray-50 rounded-lg">
									<Star className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
									<p className="text-sm font-semibold text-gray-800">Quality Products</p>
								</div>
								<div className="text-center p-4 bg-gray-50 rounded-lg">
									<GraduationCap className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
									<p className="text-sm font-semibold text-gray-800">Expert Training</p>
								</div>
								<div className="text-center p-4 bg-gray-50 rounded-lg">
									<Calendar className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
									<p className="text-sm font-semibold text-gray-800">Flexible Schedule</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-yellow-500 rounded-xl p-8 text-black">
							...
							<div className="border-t border-black/20 pt-6">
								...
								<p className="text-sm opacity-90">
									Please note that appointments require a 24-hour advance booking. Cancellations must be made at least 48 hours in advance. A deposit may be required for certain services.
							</p>
						</div>
					</div>
				</div>
